...
polling:
  interval_ms: 30000
workspace:
  root: "~/.symphony/workspaces/lattix-mesh-documentation"
hooks:
  timeout_ms: 120000
  after_create: |
    set -euo pipefail
    git clone --recurse-submodules --branch "v0.1.0" "https://github.com/LATTIX-IO/lattix-mesh-documentation.git" .
  before_run: |
    set -euo pipefail
...
symphony:
  ...
  path: "lattix-mesh-documentation"
  remote: "https://github.com/LATTIX-IO/lattix-mesh-documentation.git"
  default_branch: "v0.1.0"
  linear_project_name: "Compliance & Documentation"
  technologies:
    - docs
---

# Symphony Workflow — lattix-mesh-documentation

You are the coding agent for **lattix-mesh-documentation** (lattix-mesh-documentation) running under Symphony. Symphony has selected this Linear issue and created an isolated per-issue workspace for you. Treat the workspace as the only place where commands and file edits may run.
...
- Linear project: Compliance & Documentation (2a4ba7a120dc)
- Repository path: lattix-mesh-documentation
- Default branch: v0.1.0
- Detected technology profile: docs
