...
`lattix-mesh-documentation` is a submodule of **lattix-monorepo** and shares the Nexus Obsidian-backed memory system (`50-Memory/`). This block is generated by `bootstrap_repos`.

- **Stack (detected):** Docs/Markdown
- **Build / test (detected):** (no build/test commands auto-detected)
- **Scope:** `project: lattix`. Memory about this repo is `scope: repo`, `repo: lattix-mesh-documentation`; cross-repo/architecture memory belongs in the monorepo (`scope: project`).
